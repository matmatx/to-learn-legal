...
Intérêt légitime :
1. Maintenance technique et correction des bugs.
2. Suivi technique : En cas de signalement de bug de votre part, nous utilisons votre adresse e-mail exclusivement pour vous informer de la résolution du problème.
...
## 6. Protection des mineurs (Limite d'âge)
